package com.finio.backend.iam.interfaces.acl;
 ...
 * IamContextFacade
 * <p>
 * This class is a facade for the IAM context. It provides a simple interface
 * for other bounded contexts to interact with the
 * IAM context.
...
public class IamContextFacade {
    ...
    public Long createUser(String username, String password) {
        ...
        var result = userCommandService.handle(signUpCommand, username);
        if (result.isEmpty())
            return 0L;
     ...
     * @param username  The username of the user.
     * @param password  The password of the user.
     * @param roleNames The names of the roles of the user. When a role does not
     *                  exist, it is ignored.
     * @return The id of the created user.
     */
