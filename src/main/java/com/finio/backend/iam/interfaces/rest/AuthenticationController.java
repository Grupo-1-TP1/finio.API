...
import com.finio.backend.iam.interfaces.rest.resources.SignUpResource;
import com.finio.backend.iam.interfaces.rest.resources.UserResource;
import com.finio.backend.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.finio.backend.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.finio.backend.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
...
public class AuthenticationController {
    ...
    public ResponseEntity<UserResource> signUp(@RequestBody SignUpResource signUpResource) {
        ...
        var user = userCommandService.handle(signUpCommand, signUpResource.name());
        if (user.isEmpty()) {
