package com.finio.backend.iam.infrastructure.tokens.jwt;
 ...
 * This interface is used to inject the JWT token service in the
 * {@link com.finio.backend.iam.infrastructure.tokens.jwt.services.TokenServiceImpl}
 * class.
 */
